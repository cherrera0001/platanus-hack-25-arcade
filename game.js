...
g.fillStyle(0xd4a574);g.fillRoundedRect(2,6,32,24,10);
g.fillStyle(0xa67c52,.7);g.fillRoundedRect(4,12,28,14,8);
g.fillStyle(0xe8d5b7,.4);g.fillRoundedRect(6,14,24,10,6);
...
g.fillStyle(0x8b6f47);g.fillEllipse(18,24,8,4);
g.fillStyle(0xf4e4c1);g.fillRect(6,26,24,2);
g.fillStyle(0xb8865b);g.fillRect(4,24,3,4);g.fillRect(29,24,3,4);
g.fillStyle(0x7a5d3f,.6);
g.beginPath();g.moveTo(10,22);g.lineTo(6,24);g.strokePath();
g.beginPath();g.moveTo(26,22);g.lineTo(30,24);g.strokePath();
g.fillStyle(0xc9a082);g.fillTriangle(18,22,16,26,20,26);
g.generateTexture('gato',36,36);g.clear();

g.fillStyle(0xf9f4e8);g.fillRoundedRect(6,6,22,22,9);
g.fillStyle(0xfffbf2);g.fillRoundedRect(8,10,18,18,8);
g.fillStyle(0xf0e4d2);g.fillRoundedRect(12,10,10,18,6);
g.fillStyle(0xe6d4b8);g.fillRoundedRect(13,12,8,14,5);
g.strokePath();
g.fillStyle(0xfff6d8,.45);g.fillRect(10,16,18,2);
g.fillStyle(0xe3c99a);g.fillRoundedRect(7,6,24,6,4);
g.fillStyle(0xfff0cf);g.fillRoundedRect(7,6,24,3,3);
g.fillStyle(0x3b1e0f);g.fillEllipse(17,16,14,8);
g.fillStyle(0x2a1609,.9);g.fillEllipse(17,17,12,6);
g.fillStyle(0xffd9a0,.6);g.fillEllipse(13,15,4,3);g.fillEllipse(21,15,4,3);
g.fillStyle(0xffc94d,.8);g.fillTriangle(11,23,17,13,23,23);
g.fillStyle(0x55260f);g.fillTriangle(12,23,17,15,22,23);
g.fillStyle(0xffe9b8,.9);g.fillRect(14,24,6,2);
g.fillStyle(0xffffff,.7);g.fillRect(15,24,4,1);
g.fillStyle(0xd1b18a);g.fillRoundedRect(4,10,4,14,3);
g.fillStyle(0xf5f1e8);g.fillCircle(6,13,2);
g.fillStyle(0xf5f1e8,.6);g.fillCircle(6,19,1.8);
